...
'api_key': ' ',
  ...
  'sort_by': 'best_seller',
  'output': 'json',
  'url': 'https://www.homedepot.com/b/Appliances-Refrigerators/N-5yc1vZc3pi?catStyle=ShowProducts'
}
...
for i in range(0,5):
  ...
  k = 0
  while(True):
    if(result["search_results"][i]["product"]["features"][k]['name'] == "Total Capacity (cu. ft.)"):
...
refrigeratorSheet = client.open("Hackathon 2023").worksheet("refrigerator")
